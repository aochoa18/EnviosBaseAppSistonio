<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategoriaProductoEdit.aspx.cs" Inherits="Enviosbase.CategoriaProducto.CategoriaProductoEdit" %>
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">CATEGORIA PRODUCTO</h3>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2" style="display:none">
                            ...
                            <asp:Label ID="lbId" runat="server" CssClass="form-control-static" MaxLength="100" onkeypress="return check(event, 2)"></asp:Label>
                        </div>
                        <div class="col-lg-6">
                            <label class="control-label">Nombre</label><span style="color: red;">*</span>
                            <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control" MaxLength="2000" onkeypress="return check(event, 1)"></asp:TextBox>
                        </div>
                        <div class="row">
                            <div class="col-lg-1">
