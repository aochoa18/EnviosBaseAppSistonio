<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DomiciliarioList.aspx.cs" Inherits="Enviosbase.Domiciliario.DomiciliarioList" %>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">LISTADO DOMICILIARIOS</h3>
                        </div>
                                ...
                                <table id="example2" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>MODELO</th>
                                            <th>PLACA</th>
                                            <th>IMAGEN <br /> DOCUMENTO</th>
                                            <th>IMAGEN <br /> LICENCIA</th>
                                            <th>IMAGEN <br /> SOAT</th>
                                            <th>IMAGEN <br /> TARJETA</th>
                                            <th>FECHA</th>
                                            <th>ESTADO</th>
                                            <th>ACCIONES</th>
                                        </tr>
